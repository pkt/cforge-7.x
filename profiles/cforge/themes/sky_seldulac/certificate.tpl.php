...
<div class = "<?php print $classes; ?>">
  ...
  <?php if ($desc_fieldname = variable_get('transaction_description_field')) : ?>
    ...
    <?php print drupal_render($additional[$desc_fieldname]) ?><br />
  <?php endif; ?>
  <?php
    if (isset($additional['offers_wants_categories'])) {
      print drupal_render($additional['offers_wants_categories']);
    }
  ?>
  ...
  <div id="dependent-transactions">
    ...
    <?php print drupal_render ($dependents); ?>
  </div>
  <?php endif; ?>
